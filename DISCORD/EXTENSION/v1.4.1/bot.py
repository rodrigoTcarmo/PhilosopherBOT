...
import random
import textwrap
from Img.char_list import filosofo
...
async def on_ready():
    ...
    embed_1.set_footer(text=f'PHILOSOPHER BOT EXTENSION ESTÁ ONLINE!🟢')
...
async def sobre(mensagem):
    ...
    LOGO = 'https://cdn.discordapp.com/attachments/750556593199906956/769865220680056832/logo_new_emoji_newfundo.png'

    embed_1 = discord.Embed(

        title='Sobre Philosopher BOT EXTENSION:',
