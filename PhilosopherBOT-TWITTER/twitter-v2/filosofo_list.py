...
filosofo = [
    ...
    # -------------------------------
    Image.open("images/putin.png"),
    Image.open("images/aristoteles_2.png"),
    Image.open("images/ada.png"),
    Image.open("images/amoedo.png"),
    Image.open("images/bolsonaro.png"),
    Image.open("images/deus.png"),
    Image.open("images/juliocesar.png"),
    Image.open("images/kimjongil.png"),
    Image.open("images/malcomx.png"),
    Image.open("images/nicolau_czar.png"),
    Image.open("images/pele.png"),
    Image.open("images/platao_2.png"),
    Image.open("images/rosa.png")

]

filosofo_special = [

    Image.open("images/monark.png"),
    Image.open("images/shelby.png"),
    Image.open("images/veiohavan.png"),
    Image.open("images/renatorusso.png"),
    Image.open("images/michael_scott.png"),
    Image.open("images/lucifer.png"),
    Image.open("images/dwight.png"),
